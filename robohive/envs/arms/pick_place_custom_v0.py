...
class FrankaPickPlaceDataV0(env_base.MujocoEnv):
    ...
    def _setup(self,
        ...
        # NOTE: object_sid seems to be a fixed object, for example "obj0" 
        # that the robot is expected to bring to the target
    ...
    def get_obs_dict(self, sim):
        ...
        # NOTE: The environment expects an object: "obj0" which the
        # robot is expected to move to desired target, so that it can
        # compute errors values to be used for reward definition (?)
    ...
    def get_reward_dict(self, obs_dict):
        # NOTE: for now removing the default expected object,
        # therefore disabled reward computation
